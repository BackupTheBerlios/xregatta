...
public class MetaInfo {
	...
	public Element getXMLTree(String prefix) {
		...
		el.addContent(new Element("description", DC_NAMESPACE).setText(description));
		el.addContent(new Element("publisher", DC_NAMESPACE).setText(publisher));
		el.addContent(new Element("date", DC_NAMESPACE).setText(date.toGMTString()));
		el.addContent(new Element("creator", DC_NAMESPACE).setText(XRegatta.CREATOR));
		return el;
	}
}
