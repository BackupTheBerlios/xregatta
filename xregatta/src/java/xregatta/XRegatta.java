...
public class XRegatta 
{
    ...
    public static void main( String[] args ) throws IOException
    {
        ...
        inv.setHost("Mainzer Ruder-Verein von 1878 e.V., LRV Rheinland-Pfalz/Saarbrücken");
        ...
        Document xregatta = new Document(new Element("regattas", Invitation.NAMESPACE));
        xregatta.getRootElement().addContent(mi.getXMLTree(CREATOR));
        xregatta.getRootElement().addContent(inv.getXMLTree());
